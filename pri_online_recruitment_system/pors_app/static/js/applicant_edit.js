$(document).ready(function () {
    ...
    $(".mydatepicker").each(function () {
        //$(this) iterate through object elements
        $(this).datepicker({
            uiLibrary: 'bootstrap4',
            iconsLibrary: 'fontawesome',
            format: 'mmm dd yyyy',
    ...
    // upon loading
    let civil_status = $("#id_civil_status").val();
    ...
    $("#add-field-form-applicant-siblings").click((e) => {
        e.preventDefault();
        let form_idx = $("#form-applicant-siblings #id_siblings_applicant_fk-TOTAL_FORMS").val();
        let form_idx_initial = $("#form-applicant-siblings #id_siblings_applicant_fk-INITIAL_FORMS").val();
        ...
        if (form_idx_after > (parseInt(form_idx_initial) + 1)) {
    ...
    $("#del-field-form-applicant-siblings").click((e) => {
        ...
        $('#form-applicant-siblings-set #form-applicant-siblings div.form-row').slice(-2).remove();
        $("#form-applicant-siblings #id_siblings_applicant_fk-TOTAL_FORMS").val(parseInt(form_idx) - 1);
        ...
        console.log("Index: " + form_idx);
        console.log("Index After: " + form_idx_after);
        console.log("Initial: " + (parseInt(form_idx_initial) + 1));
    ...
    $("#add-field-form-applicant-employment-history").click((e) => {
        e.preventDefault();
        let form_idx = $("#form-applicant-employement-history-set #form-applicant-employement-history #id_employment_applicant_fk-TOTAL_FORMS").val();
        let form_idx_initial = $("#form-applicant-employement-history-set #form-applicant-employement-history #id_employment_applicant_fk-INITIAL_FORMS").val();
        ...
        let row = '<div class="form-row">' +
            ...
            '</div>' +
            '<div class="form-group col-md-4 mb-0"> ' +
            list_divs[12].outerHTML +
            '</div>' +
            '</div>' +
            '<div class="form-row">' +
            '<div class="form-group col-md-12 mb-0">' +
            list_divs[15].outerHTML +
            '</div>' +
            '</div> ';
        ...
        // https://gijgo.com/datepicker/methods/destroy
        // Remove the duplicated datepicker and add new
        $(`#id_employment_applicant_fk-${form_idx}-date_from`).datepicker().destroy().datepicker({
            uiLibrary: 'bootstrap4',
            iconsLibrary: 'fontawesome',
            format: 'mmm dd yyyy',
        });
        ...
        $(`#id_employment_applicant_fk-${form_idx}-date_to`).datepicker().destroy().datepicker({
            uiLibrary: 'bootstrap4',
            iconsLibrary: 'fontawesome',
            format: 'mmm dd yyyy',
        });

        $("#form-applicant-employement-history-set #form-applicant-employement-history #id_employment_applicant_fk-TOTAL_FORMS").val(parseInt(form_idx) + 1);

        let form_idx_after = $("#form-applicant-employement-history-set #form-applicant-employement-history #id_employment_applicant_fk-TOTAL_FORMS").val();
        ...
        // converts to string html format
        // console.log(divs.html());
        console.log(list_divs[0].outerHTML);
        return false;
    });
    ...
    $("#del-field-form-applicant-employment-history").click((e) => {
        ...
        $("#form-applicant-employement-history-set #form-applicant-employement-history div.form-row").slice(-3).remove();
        $("#form-applicant-employement-history-set #form-applicant-employement-history #id_employment_applicant_fk-TOTAL_FORMS").val(parseInt(form_idx)-1);
    ...
    $("#add-field-form-applicant-trainings").click((e) => {
        ...
        let form_idx_initial = $("#form-applicant-trainings-set #form-applicant-trainings #id_tranings_applicant_fk-INITIAL_FORMS").val();
        ...
        $(`#id_tranings_applicant_fk-${form_idx}-date_attended`).datepicker().destroy().datepicker({
            uiLibrary: 'bootstrap4',
            iconsLibrary: 'fontawesome',
            format: 'mmm dd yyyy',
        });
    ...
    $("#del-field-form-applicant-trainings").click((e) => {
        ...
        $("#form-applicant-trainings-set #form-applicant-trainings div.form-row").slice(-2).remove();
        $("#form-applicant-trainings-set #form-applicant-trainings #id_tranings_applicant_fk-TOTAL_FORMS").val(parseInt(form_idx)-1);
    ...
    $("#add-field-form-applicant-character-reference").click((e) => {
        ...
        let form_idx_initial = $("#form-applicant-character-reference-set #form-applicant-character-reference #id_character_references_applicant_fk-INITIAL_FORMS").val();
    ...
    $("#del-field-form-applicant-character-reference").click((e) => {
        ...
        let form_idx = $("#form-applicant-character-reference-set #form-applicant-character-reference #id_character_references_applicant_fk-TOTAL_FORMS").val();
        let form_idx_initial = $("#form-applicant-character-reference-set #form-applicant-character-reference #id_character_references_applicant_fk-INITIAL_FORMS").val();
        $("#form-applicant-character-reference-set #form-applicant-character-reference div.form-row").slice(-2).remove();
        $("#form-applicant-character-reference-set #form-applicant-character-reference #id_character_references_applicant_fk-TOTAL_FORMS").val(parseInt(form_idx)-1);
